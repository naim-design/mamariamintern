...
function seedingPlatformClass(channel){const v=String(channel||'').toLowerCase();if(v.includes('facebook page'))return 'platform-fb-page';if(v.includes('facebook akaun'))return 'platform-fb-account';if(v.includes('tiktok'))return 'platform-tiktok';if(v.includes('whatsapp'))return 'platform-whatsapp';if(v.includes('telegram'))return 'platform-telegram';return 'platform-other';}
